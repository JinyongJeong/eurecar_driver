...
set (HEADER_INCLUDE_PATH "${CATKIN_DEVEL_PREFIX}/include")
...
function(pods_install_headers)
    ...
    message (STATUS "in pods_install_headers " ${INCLUDE_OUTPUT_PATH})
    message (STATUS "in pods_install_headers dest dir" ${dest_dir})
    foreach(header ${ARGV})
        get_filename_component(_header_name ${header} NAME)
        configure_file(${header} ${HEADER_INCLUDE_PATH}/${dest_dir}/${_header_name} COPYONLY)
	endforeach(header)
	#mark them to be installed
