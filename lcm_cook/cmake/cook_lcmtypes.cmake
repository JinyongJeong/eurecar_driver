...
## YG ADD project_source_dir to local catkinws root path
...
set(CATKIN_ROOT "${CATKIN_DEVEL_PREFIX}/..")

#message (STATUS "CATKIN ROOT DIR " ${CATKIN_ROOT})
...
function(lcmtypes_build_c)
    ...
    message(STATUS "NOW gen ctype lcm " ${_lcmtypes_c_dir})
    ...
    file(GLOB _lcmtypes_c_files "${CATKIN_ROOT}/build/lcmdefs/c/*.c")
    file(GLOB _lcmtypes_h_files "${CATKIN_ROOT}/build/lcmdefs/c/*.h")
    message(STATUS "lcmtypes h riles " ${_lcmtypes_h_files})
...
function(lcmtypes_build_cpp)
    lcmtypes_get_types(_lcmtypes)
    list(LENGTH _lcmtypes _num_lcmtypes)
    message(STATUS "+++++++++++++++++ LCMTYPES INSTALL HEADRS " ${_num_lcmtypes})
    if(_num_lcmtypes EQUAL 0)
        return()
    endif()
    ...
    foreach (PACKAGE ${LCM_PCK_LIST})
        file(GLOB __tmphppfile "${CATKIN_ROOT}/build/lcmdefs/cpp/${PACKAGE}/*.hpp")
...
function(lcmtypes_build_java)
    ...
    file(GLOB_RECURSE _lcmtypes_java_files "${CATKIN_ROOT}/build/lcmdefs/java/*.java")
...
function(lcmtypes_build_python)
    ...
    set(_lcmtypes_python_dir ${CATKIN_ROOT}/build/lcmdefs/python)
...
macro(lcmtypes_build)
    ...
    # YG ADD for debug
    #message(STATUS "Cmake devel prefix " ${CATKIN_DEVEL_PREFIX})
    #message(STATUS "Cmake build prefix " ${CATKIN_BUILD_PREFIX})
